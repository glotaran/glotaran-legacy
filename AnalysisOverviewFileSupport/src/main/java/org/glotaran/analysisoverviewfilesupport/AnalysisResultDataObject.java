...
public class AnalysisResultDataObject extends MultiDataObject {
    ...
    @MIMEResolver.Registration(displayName="AnalysisResultResolver.xml",
            resource="AnalysisResultResolver.xml",
            position=900 )
    @NbBundle.Messages("Services/MIMEResolver/AnalysisResultResolver.xml=AnalysisResult Files")
