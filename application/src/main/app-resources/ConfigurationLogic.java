 ...
 */
/*
 *  Contains contributions from stackoverflow user Tirrel,
 *  http://stackoverflow.com/users/2119336/tirrel
 *  Source: http://stackoverflow.com/questions/26774879/resolved-generated-installer-creates-shortcut-that-points-to-wrong-executable
 */
...
public class ConfigurationLogic extends ProductConfigurationLogic {
    ...
    public Map<String, Object> getAdditionalSystemIntegrationInfo() {
        ...
        if (SystemUtils.isWindows()) {
            ...
            map.put("Contact", getString("CL.system.email.support"));
    ...
    private Shortcut getShortcut(
        ...
        if (SystemUtils.isWindows()) {
            if (isX64()) {
                executable = new File(location, EXECUTABLE_WINDOWS_64);
            } else {
