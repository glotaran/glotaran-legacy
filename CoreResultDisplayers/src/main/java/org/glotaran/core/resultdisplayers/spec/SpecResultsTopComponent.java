...
//    static final String ICON_PATH = "SET/PATH/TO/ICON/HERE";
    ...
    public SpecResultsTopComponent(TimpResultDataObject dataObj) {
        ...
        if (res.getJvec() != null) {
            numberOfRates = res.getJvec().length / 2;
        } else {
...
//calculate dispersion curve
    ...
    private void initComponents() {
        ...
        jTBShowCohSpec.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jTBShowCohSpec.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTBShowCohSpecActionPerformed(evt);
            }
        });
        ...
        jBExportResiduals.setFocusable(false);
        jBExportResiduals.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jBExportResiduals.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jBExportResiduals.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBExportResidualsActionPerformed(evt);
            }
        });
        jToolBar2.add(jBExportResiduals);
...
// add residuals trace to collection   
    ...
    private void jTBShowCohSpecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTBShowCohSpecActionPerformed
        plotSpectrTrace();
        jPSAS.validate();
        jPDAS.validate();
        jPDASnorm.validate();
        jPSASnorm.validate();
    }//GEN-LAST:event_jTBShowCohSpecActionPerformed
    ...
    private void jBExportResidualsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBExportResidualsActionPerformed
...
//            fittedTracesMat = res.getFittedTraces();
            ...
            for (int i = 0; i < residualTracesMat.getRowDimension(); i++) {
                ...
                for (int j = 0; j < residualTracesMat.getColumnDimension(); j++) {
                    ...
                    if (j < residualTracesMat.getColumnDimension() - 1) {
                        sb.append(",");
                    }
                }
                sb.append("\n");
