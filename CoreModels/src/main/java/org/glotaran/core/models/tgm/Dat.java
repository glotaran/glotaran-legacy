 ...
 *         &lt;element name="oscspecPanel" type="{http://www.nat.vu.nl/~jsnel/Schema/TgmSchema}CohspecPanelModel"/>
...
public class Dat {
    ...
    @XmlElement(required = true, nillable = true)
    protected CohspecPanelModel oscspecPanel;
    @XmlElement(required = true, nillable = true)
     ...
     *     
     */
    public CohspecPanelModel getOscspecPanel() {
        return oscspecPanel;
    }
     ...
     *     
     */
    public void setOscspecPanel(CohspecPanelModel value) {
