 ...
 * @author slapten
 */
public class SimulationInputContainerWidget extends Widget {

    private boolean connected = false;
    private List<PropertyChangeListener> listeners = Collections.synchronizedList(new LinkedList<PropertyChangeListener>());

    public SimulationInputContainerWidget(GlotaranGraphScene scene, SimulationContainerComponent component, String name) {
        super(scene);
    ...
    public SimulationContainerComponent getContainerComponent() {
        return (SimulationContainerComponent) ((ComponentWidget) getChildren().get(1)).getComponent();
    }
